...
#login-app {
    ...
    background-color: #00332c; /* 背景颜色 */
    background-image: url('/public/背景2.jpg'); /* 背景图片 */
...
/* 登录容器的样式 */
.login-container {
    background-color: rgba(255, 255, 255, 0.9); /* 背景颜色带透明度 */
    color: #333; /* 字体颜色 */
    padding: 40px; /* 内边距 */
    border-radius: 15px; /* 边角圆角 */
...
/* 提交按钮的悬停效果 */
.btn-primary:hover {
    background-color: #00594c; /* 背景颜色变化 */
}
...
.footer {
    ...
    background-color: rgba(0, 0, 0, 0.5); /* 背景颜色带透明度 */
